 ...
 */
final class Version20190502081807 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, code VARCHAR(20) NOT NULL, name VARCHAR(255) DEFAULT NULL, eng_name VARCHAR(512) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE resolution (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE TABLE scan (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, path CLOB NOT NULL, scanned_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, completed BOOLEAN NOT NULL)');
